...
namespace Leaf.Web.Controllers
{
    public class ConferenceController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,Code,Name,StartDate,EndDate,Description,ShortDescription,IsPublished")] Conference conference)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="Id,Code,Name,StartDate,EndDate,Description,ShortDescription,IsPublished")] Conference conference)
        {
            if (ModelState.IsValid)
            {
